<head>
    ...
    <meta name="title" content="<?php echo isset($title) ? $title : $SETTING['web_title'] ?>">
    <meta name="description" content="<?php echo $SETTING['skill_intro'] ?>">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="Min Lwin Kyaw | Personal Profile">
    ...
    <!-- //web fonts -->
    <!-- Template CSS -->
    <link rel="stylesheet" href="/assets/css/style-starter.css?version=5">
</head>