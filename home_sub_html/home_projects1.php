        ...
        <div class="container">
            ...
            <section id="content1" class="tab-content text-left">
                <div class="d-grid grid-col-3">
                    ...
                    <a href="#" id="" class="products-4 p-2" style="background-color:var(--opposite-color); color: white; border: 1px solid var(--opposite-color); border-radius: 2px; text-align: center;">View More</a>
                </div>
            </section>
